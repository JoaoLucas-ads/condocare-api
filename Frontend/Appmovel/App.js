  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.detailValue}>Usuária do Sistema</Text>

        <Text style={styles.detailLabel}>Tipo de acesso</Text>
        <Text style={styles.detailValue}>Administrador</Text>

        <Text style={styles.detailLabel}>E-mail</Text>
        <Text style={styles.detailValue}>usuario@email.com</Text>
      </View>
    </View>
  );
}
